window.addEventListener('load', function() {
	...
	document.getElementById("remote-firmware").addEventListener('change', function() {
		alert("changing firmware")
...
function startRemoteFirmware(firmware) {
	...
	xhr.open("GET", "cgi-bin/start_remote_firmware.cgi?firmware=" + firmware, true);
	xhr.send();
}
